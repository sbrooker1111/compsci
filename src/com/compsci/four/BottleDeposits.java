/*
Program #8: Bottle Deposits:

In many jurisdictions a small deposit is added to drink containers to encourage people to recycle them.
In one particular jurisdiction, a drink container holding one litre of less have a $0.10 deposit,
...
those containers. Format the output so that it includes a dollar sign and always displays exactly two
decimal places.
 */
