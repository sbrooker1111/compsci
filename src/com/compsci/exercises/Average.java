...
entered by the user. The user will enter 0 as a sentinel (flag) to indicate that no further values
will be provided. Your program should display an appropriate error message if the first value entered
by the user is 0.
